...
.method private configureInternalConfiguration()V
    ...
    .line 289
    invoke-direct {p0}, Lcom/android/server/wifi/SoftApManager;->readKanoSoftApTimeoutMillis()J
...
.method private readKanoSoftApTimeoutMillis()J
    .registers 11
    ...
    const-string v5, "/data/kano_softap_timeout"

    invoke-direct {v4, v5}, Ljava/io/FileReader;-><init>(Ljava/lang/String;)V

    invoke-direct {v3, v4}, Ljava/io/BufferedReader;-><init>(Ljava/io/Reader;)V
    :try_end_11
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_11} :catch_72
    ...
    const-string v7, "kano_patched_wifi:using softap timeout "
    ...
    :try_end_67
    .catch Ljava/lang/Exception; {:try_start_12 .. :try_end_67} :catch_74
    ...
    const-string v4, "kano_patched_wifi:invalid softap timeout config, fallback to disabled"

    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_5f
    .catch Ljava/lang/Exception; {:try_start_57 .. :try_end_5f} :catch_74
    ...
    const-string v6, "kano_patched_wifi:failed to read softap timeout, fallback to disabled. Exception: "
...
.method private readKanoHiddenSsidEnabled()Z
    .registers 8
    ...
    const-string v4, "/data/kano_is_hidden_ssid"
    ...
    const-string v3, "kano_patched_wifi:hidden ssid enabled by /data/kano_is_hidden_ssid"
    ...
    const-string v5, "kano_patched_wifi:failed to read hidden ssid config, fallback to visible. Exception: "
...
.method private startSoftAp()I
    ...
    .line 739
    :cond_68
    invoke-direct {p0}, Lcom/android/server/wifi/SoftApManager;->readKanoHiddenSsidEnabled()Z
    ...
    iput-object v2, p0, Lcom/android/server/wifi/SoftApManager;->mCurrentSoftApConfiguration:Landroid/net/wifi/SoftApConfiguration;
