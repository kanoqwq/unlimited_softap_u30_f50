...
.method public static fromWifiConfiguration(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/SoftApConfiguration;
    ...
    :try_end_3b
    .catch Ljava/lang/IllegalArgumentException; {:try_start_a .. :try_end_3b} :catch_54
    .catch Ljava/lang/IllegalStateException; {:try_start_a .. :try_end_3b} :catch_40
...
.method public static updateSoftApCapabilityWithAvailableChannelList(Landroid/net/wifi/SoftApCapability;Landroid/content/Context;Lcom/android/server/wifi/WifiNative;)Landroid/net/wifi/SoftApCapability;
    ...
    new-instance v6, Lcom/android/server/wifi/WifiConnectivityManager$$ExternalSyntheticLambda9;

    invoke-direct {v6}, Lcom/android/server/wifi/WifiConnectivityManager$$ExternalSyntheticLambda9;-><init>()V
